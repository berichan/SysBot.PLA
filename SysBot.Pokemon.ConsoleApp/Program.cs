...
#pragma warning restore CA1031 // Do not catch general exception types
        ...
        {
            var bot = new PokeBotState { Connection = new SwitchConnectionConfig { IP = "192.168.0.1", Port = 6000 }, InitialRoutine = PokeRoutineType.PLAFlexTrade };
    ...
    public static class BotContainer
    {
        ...
        {
            ProgramMode.PLA => new PokeBotRunnerImpl<PA8>(prog.Hub, new BotFactoryPLA()),
